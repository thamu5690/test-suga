...
@Embeddable
public class MigrationStudentHistoryAcadPKModel implements Serializable {
	...
	@Column(name="CRS_CTALOG_GENERIC_COURSE_TYPE")
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MigrationStudentHistoryAcadPKModel other = (MigrationStudentHistoryAcadPKModel) obj;
		if (courseId == null) {
