...
@Embeddable
public class CourseRegistrationWaitingMovePKModel implements Serializable {
	...
	@Column(name="MOVED_TIMESTAMP")
	@Temporal(TemporalType.TIMESTAMP)
	private Date movedTimestamp;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CourseRegistrationWaitingMovePKModel other = (CourseRegistrationWaitingMovePKModel) obj;
		if (courseId == null) {
